...
export default function About() {
  return (
    <section
      id="about"
      className="py-20 md:py-32 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-slate-50 to-primary-50/20 dark:from-slate-950 dark:to-slate-900"
    >
      <div className="container mx-auto max-w-6xl">
        ...
        {/* Bio Section */}
        <div className="mb-16">
          <div className="bg-white/80 dark:bg-slate-800/50 backdrop-blur-md rounded-xl shadow-lg p-8 md:p-12 border border-slate-100 dark:border-slate-700">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {certificates.map((cert, index) => (
              <a
                ...
                className="bg-white/80 dark:bg-slate-800/50 backdrop-blur-sm rounded-xl shadow-lg p-6 border border-slate-100 dark:border-slate-700 hover:shadow-xl transition-all text-center cursor-pointer hover:scale-105"
              >
        ...
        <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {skillCategories.map((category, index) => (
              <div
                key={index}
                className="bg-white/80 dark:bg-slate-800/50 backdrop-blur-sm rounded-xl shadow-lg p-6 border border-slate-100 dark:border-slate-700"
              >
